...
You can include a GIF or screenshots here. Replace `[PATH_TO_YOUR_PREVIEW.gif]` with the actual path to your GIF or image files.

![](https://github.com/Cyunrei/Video-Live-Wallpaper/blob/master/preview.gif)
_Example preview (replace with your own!)_
